...
public class ExpenseReportController {
    ...
    public ResponseEntity<ApiResponseDTO> insertExpenseReport(@RequestBody SimpleExpenseReportDTO newExpenseReport, @RequestParam int missionId) throws FunctionalException, EntityNotFoundException {
        ...
        if (result) {
            ApiResponseDTO response = new ApiResponseDTO(
                    "Success",
                    "Note de frais insérée avec succès",
                    HttpStatus.OK.value(),
                    LocalDateTime.now(),
                    newExpenseReport
            );
            ...
            ApiResponseDTO response = new ApiResponseDTO(
                    ...
                    "Échec de l'insertion : la note de frais n'a pas pu être insérée",
    ...
    public ResponseEntity<ApiResponseDTO> updateExpenseReport(@PathVariable Long id, @RequestBody SimpleExpenseReportDTO updatedExpenseReport) throws EntityNotFoundException {
        ...
        if (result) {
            ApiResponseDTO response = new ApiResponseDTO(
                    "Success",
                    "Note de frais mise à jour avec succès",
                    HttpStatus.OK.value(),
                    LocalDateTime.now(),
            ...
            ApiResponseDTO response = new ApiResponseDTO(
                    "Internal Server Error",
                    "Échec de la mise à jour : la note de frais n'a pas pu être mise à jour",
                    HttpStatus.INTERNAL_SERVER_ERROR.value(),
                    LocalDateTime.now(),
                    null
            );
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponseDTO> deleteExpenseReport(@PathVariable Long id) throws FunctionalException, EntityNotFoundException {
        boolean result = expenseReportService.deleteExpenseReport(id);
        if (result) {
            ApiResponseDTO response = new ApiResponseDTO(
                    "Success",
                    "Note de frais supprimée avec succès",
                    HttpStatus.OK.value(),
                    LocalDateTime.now(),
                    null
            );
            ...
            ApiResponseDTO response = new ApiResponseDTO(
                    "Internal Server Error",
                    "Échec de la suppression : la note de frais n'a pas pu être supprimée",
                    HttpStatus.INTERNAL_SERVER_ERROR.value(),
                    LocalDateTime.now(),
                    null
            );
